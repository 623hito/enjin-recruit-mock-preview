...
(function () {
  ...
  var CONFIRMED = ['hero_main', 'honda_ceo', 'hero_female', 'office_about', 'interview_0', 'ohana_wall', 'wanted_person', 'business', 'office_lounge', 'hero_hs', 'platform_biz', 'estate_biz'];   // 確定素材（interview_0 は 01〜06 全部に前方一致）
  // バッジ対象外（ロゴ・アイコン類）
